...
const SOURCE_COLOR: Record<string, string> = {
  ...
  'Al Jazeera':    'bg-amber-500/15 text-amber-400',
  'The Guardian':  'bg-blue-500/15 text-blue-400',
  'Foreign Policy':'bg-violet-500/15 text-violet-400',
  'DW Brasil':     'bg-emerald-500/15 text-emerald-400',
}
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-base font-semibold">Geopolítica</h1>
          <p className="text-xs text-muted-foreground mt-0.5">
            BBC World · NYT World · Al Jazeera · The Guardian · Foreign Policy · DW Brasil
          </p>
        </div>
        {lastAt && (
